...
<body>
	...
	<div id="detail_table">
		...
		<ul>
			...
			<!-- 구매하기 클릭 시 자바스크립트 함수로 상품 번호, 상품명, 판매 가격, 이미지 파일 이름을 전달 -->
	...
	<div id="container">
		...
		<div class="tab_container">
			<div class="tab_content" id="tab1">
				...
				<!-- replace 함수를 이용해 저자 소개에 포함된 crcn(개행문자)을 br(<br>태그)로 대체 -->
			...
			<div class="tab_content" id="tab2">
				...
				<div class="writer">저자 : ${goods.goods_writer}</div>
				  ...
				  <!-- 마찬가지로 상품 목차에 포함된 crcn(개행문자)을 br(<br>태그)로 대체 -->
			...
			<div class="tab_content" id="tab4">
				...
				<!-- 출판사서평에 포함된 crcn(개행문자)을 br(<br>태그)로 대체 -->
			...
			<div class="tab_content" id="tab5">
				...
				<!-- 상품 추천평에 포함된 crcn(개행문자)을 br(<br>태그)로 대체 -->
