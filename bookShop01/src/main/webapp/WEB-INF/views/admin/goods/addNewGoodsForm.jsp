...
<script type="text/javascript">
  ...
  function fn_addFile() {
	  if(cnt == 0){
		  ...
		  /* name='main_image' : 첫 번째 파일 업로드는 메인 이미지를 첨부하므로 name 속성을 
		   *					 main_image로 설정 */
		  $("#d_file").append("<br>"+"<input  type='file' name='main_image' id='f_main_image' />");
		  
	  } else {
		  
		  /* name='detail_image"+cnt+"' : 그 외의 이미지들은 name 속성의 값을
		   * 							  detail_image+cnt 로 설정*/
			...
			<div class="tab_content" id="tab7">
				...
				<table >
					<tr>
			            ...
			            <!-- onClick="fn_addFile()" : 파일 추가 클릭 시 파일 업로드가 동적으로 추가 -->
